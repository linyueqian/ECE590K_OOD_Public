...
def print_all_results(results, in_dataset, name, optimizer, datasets, method):
    mtypes = ['FPR95', 'AUROC', 'AUIN']
...
def compute_traditional_ood(base_dir, in_dataset, out_datasets, method, name, optimizer, args=None):
    ...
    print_all_results(all_results, in_dataset, name, optimizer, out_datasets, method)
    return
